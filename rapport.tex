...
Notre mission était de traduire ces schémas graphiques (des ronds et des flèches) en lignes de code performantes capable de réaliser des opérations complexes comme l'intersection ou la minimisation.
\newpage
...
La principale difficulté a été la gestion des itérateurs C++ qui peuvent être complexes à manipuler sans pointeurs. Nous avons également rencontré des difficultés à implémenter des algorithmes complexes mais cela était toute fois formateur.
\newpage
\section{Conclusion}
...
\begin{itemize}
    \item Maîtriser la librairie standard C++ (STL).
    \item Comprendre les notions abordées durant l'UE.
\end{itemize}
"Que retenir de ce travail ?" : Qu'une bonne structure de données est la clé d'un algorithme performant.
\newpage
